...
assert.match(html, /Quản Lý Nhập Hàng V4\.2\.2/);
assert.match(html, /app\.js\?v=4\.2\.2/);
assert.match(html, /v42\.js\?v=4\.2\.2/);
...
assert.equal(manifest.name, "Quản Lý Nhập Hàng V4.2.2");
const serviceWorker = fs.readFileSync(path.join(root, "sw.js"), "utf8");
assert.match(serviceWorker, /quan-ly-nhap-hang-v4-2-2/);
...
console.log("V4.2.2 smoke tests: PASS");
